        ...
        this.alignments = [
            {
                ...
                isApplied: () =>
                    ImageFormatClass.value(this.activeEle) == 'left'
            },
            {
                ...
                isApplied: () =>
                    ImageFormatClass.value(this.activeEle) == 'center'
            },
            {
                icon: IconAlignRight,
                apply: () => {
                ...
                isApplied: () =>
                    ImageFormatClass.value(this.activeEle) == 'right'
            },
            {
                icon: IconFloatFull,
                apply: () => {
                ...
                isApplied: () =>
                    ImageFormatClass.value(this.activeEle) == 'full'
            }
        ];
    }
